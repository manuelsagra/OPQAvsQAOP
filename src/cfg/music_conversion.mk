...
$(eval $(call AKS2DATA, CONVERT      , sound/menu.aks , msc_menu , 0x9B88 ))
$(eval $(call AKS2DATA, CONVERT      , sound/select.aks , msc_select , 0x9ED2 ))
$(eval $(call AKS2DATA, CONVERT      , sound/gameover.aks , msc_gameover , 0xA04E ))
$(eval $(call AKS2DATA, CONVERT      , sound/complete.aks , msc_complete , 0xA120 ))
$(eval $(call AKS2DATA, CONVERT      , sound/stage.aks , msc_stage , 0xA22E ))

$(eval $(call AKS2DATA, SET_SFXONLY  , yes   ))
$(eval $(call AKS2DATA, CONVERT      , sound/sfx.aks , sfx , 0x9AE0 ))
