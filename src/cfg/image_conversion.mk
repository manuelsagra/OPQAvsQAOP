...
PALETTE=0 13 26 3 6 16 24 12 15 2 1 11 9 4 5 25 
...
$(eval $(call IMG2SP, SET_FOLDER      , src/gfx               ))

$(eval $(call IMG2SP, CONVERT         , img/bg.png ,       4, 8,  bg_bg, , bg_tileset))
$(eval $(call IMG2SP, CONVERT         , img/pieces.png ,   8, 16, pc_pieces, , pc_tileset))
$(eval $(call IMG2SP, CONVERT         , img/letters.png ,  4, 16, lt_letters, , lt_tileset))
$(eval $(call IMG2SP, CONVERT         , img/numbers.png ,  4, 16, nb_numbers, , nb_tileset))
$(eval $(call IMG2SP, CONVERT         , img/avatars.png , 16, 32, av_avatars, , av_tileset))


#$(eval $(call IMG2SP, SET_FOLDER      , dsk                    ))
#$(eval $(call IMG2SP, SET_PALETTE_FW  , $(PALETTE2)            ))
#$(eval $(call IMG2SP, SET_IMG_FORMAT  , screen                 ))
#$(eval $(call IMG2SP, SET_OUTPUT      , bin                    ))
#$(eval $(call IMG2SP, CONVERT         , img/loading.png, 160, 200, loading))
